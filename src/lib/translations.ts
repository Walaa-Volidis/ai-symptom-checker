export const translations = {
  en: {
    ...
    appSubtitle: "Describe your symptoms and get instant insights powered by AI",
    
    // Input Section
    inputTitle: "Tell us how you're feeling",
    inputPlaceholder: "Describe your symptoms in detail... (e.g., 'I have a headache, feeling tired, and have a sore throat')",
  ...
  ar: {
    ...
    inputPlaceholder: "صف أعراضك بالتفصيل... (مثال: 'لدي صداع، أشعر بالتعب، ولدي التهاب في الحلق')",
